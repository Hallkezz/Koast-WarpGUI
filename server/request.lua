...
function WarpGui:WarpMessageTo( args )
	Chat:Send( args.target, args.message, textColor )
end

-----------------------------------------------------------------------------------
--Warp requester to target
function WarpGui:WarpTo( args )
	Chat:Send( args.target, args.requester:GetName() .. " teleported to you.", textColor )
	Chat:Send( args.requester, "You were teleported to " .. args.target:GetName() .. ".", textColor )
	--print( args.requester:GetName() .. " warp to " .. args.target:GetName() )
